...
import { Heart, Sparkles, ArrowLeft, Phone, Mail, Copy, Check, Loader2 } from "lucide-react";
...
const Match = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Header */}
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-xl px-6 py-4">
        <button
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-12">
        ...
        {/* Tip */}
        <p className="mt-10 text-xs text-muted-foreground/60 text-center max-w-xs">
          {t("match.tip")}
        </p>
      </div>
