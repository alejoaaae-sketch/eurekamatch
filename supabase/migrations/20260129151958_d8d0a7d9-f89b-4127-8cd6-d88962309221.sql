-- Drop and recreate the check_mutual_match function with SECURITY DEFINER
-- This allows the trigger to insert matches bypassing RLS
...
-- Also update check_matches_on_profile_update to use SECURITY DEFINER
